...
Created By : https://github.com/Numapu
Created By : https://github.com/Numapu
*/

exports.textTnC = () => {
    return `
Whatsapp : wa.me/6288214267451
Author? : Numapu
Instagram: https://instagram.com/numapu
Github: https://github.com/Numapu
...
exports.textmenupenting = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamatt datang di NumaBot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
https://www.instagram.com/numapu
Berikut fitur yang dapat di gunakan pada bot ini✨

List menu penting NumaBot:

Silahkan Yang ingin mendapatkan info NumaBot lebih cepat ketik 
${prefix}grup
tapi gk usah keluar masuk grup ya :)

🚀 *${prefix}addbacot*
Untuk melihat bacotan member NumaBot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member NumaBot
...
2. *${prefix}donasi*
Untuk mendonasikan kepada Numapu(creator)
Usage: Ketik */donasi*.
...
15. *${prefix}getpic*
Untuk Numa Bot maling gambar orang
...
Selamat menikmati✨
_made with_❤️ @NumaBot`

}

exports.textsongmenu = (pushname) => {
   return `
Hi Kak ${pushname}👋️, selamat datang di NumaBot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
${sosmed}
Berikut fitur yang dapat di gunakan pada bot ini✨
...
*Ketik /chat* 
*Untuk Mengobrol dengan NumaBot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan NumaBot chatnya*

List menu:

1. *${prefix}menupenting*
Menampilkan menu penting di NumaBot
Usage: ketik */menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di NumaBot
Usage: ketik */menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di NumaBot
Usage: ketik */mentol*
...
exports.textmenubaru = (pushname) => {
    ...
    ❏ Prefix: 「  /  」
    ❏ Creator: Numapu
    ❏ wa.me/62881026880515
    ❏ Donasi Yuk
    ❏ https://nyawer.co/numapu
...
NumaBot terdapat 2 menu sekarang

🐳 *${prefix}menubaru* 🐳
🐳 *${prefix}𝚖𝚎𝚗𝚞lama* 🐳

Jam: *${tod}*
Total userNuma : ${coloo.length}

Jika tulisan tidak keliatan kek kotak kotak 
Ketik /help

Untuk melihat Waktu NumaBot Aktif
...
10 *${prefix}motivasi*
Untuk mendapatkan motivasi dari figo amjay
...
List menu wibuarea & kpop di NumaBot:
...
Contoh: /wolf |numa|bot
        
4. *${prefix}wolf2*
Untun membuat gambar wolf dengan text 
Usage: ketik /wolf2 |teks1|teks2
Contoh: /wolf2 |numa|bot
...
exports.textAdmin = () => {
    return `
⚠ [ *Admin Group Only* ] ⚠ 
Berikut adalah fitur admin grup yang ada pada ❣ *NumaBot* ❣!
...
⚠ [ *Owner Group Only* ] ⚠
Berikut adalah fitur owner grup yang ada pada ❣ *NumaBot* ❣!
🐼 *${prefix}kickall*
...
Kirim dana seikhlasnya isi pulsa ke nomor 087864316262
